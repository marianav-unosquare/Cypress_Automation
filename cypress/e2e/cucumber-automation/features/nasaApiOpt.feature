...
|title   |Rigel Wide             |2023-04| neo/rest/v1/neo/browse?api_key=|

Scenario: I want to test Asteroids Get Request
Given I access Nasa API
When I send a GET request on the endpoint planetary/apod?api_key=
Then I validate status code 200 and I validate status body Asteroids has id 2000433 and property id
...
|2000433|id       |planetary/apod?api_key=|